...
const Price = ({monthly} : {monthly : boolean}) => {
  return (
    <div className={`w-[400px] p-4 rounded-md border-t-[6px] border-[${monthly ? LIGHTPURPLE : DARKPURPLE}] flex flex-col gap-8 ${DARKSHADOW} hover:${PURPLESHADOW} transition-all duration-100 ease-linear`}>
      <div className='flex flex-col gap-8'>
        ...
        <NavLink to={`${PathConstant.PRICING}/payment`} state={{monthly}} className='flex'>
          <Button 
